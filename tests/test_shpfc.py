...
def test_std_pfc_step_advances_state(simple_model, simple_geometry, psi0, force_numpy_backend):
...
def test_divergence_based_shpfc_step_runs(simple_model, simple_geometry, psi0, force_numpy_backend):
